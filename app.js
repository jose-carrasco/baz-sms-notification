...
var smsnotification = require('./routes/smsnotification');
...
app.post('/ixn/activities/smsnotification/save',smsnotification.save);
app.post('/ixn/activities/smsnotification/validate',smsnotification.validate);
app.post('/ixn/activities/smsnotification/publish',smsnotification.publish);
app.post('/ixn/activities/smsnotification/execute',smsnotification.execute);
